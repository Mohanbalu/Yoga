  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 text-[#2C3B34]">
      <div className="border-b border-[#D5E2DC] pb-6 space-y-2">
        ...
        <p className="text-xs text-[#6B857B]">Effective Date: July 30, 2026 • yogyatra_shreya Yoga Studio</p>
      </div>
      ...
      <div className="space-y-6 text-xs leading-relaxed">
        <section className="space-y-2">
          ...
          <p className="text-[#52635B]">
            We respect your privacy. When you register or book a class session with yogyatra_shreya, we collect minimal personal information including your name, email address, phone number, and optional health goal notes required for instructor preparation.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p className="text-[#52635B]">
            All transactions are handled securely over 256-Bit SSL encryption via PCI-DSS compliant payment gateways (Razorpay, UPI, GPay). yogyatra_shreya does not store credit card numbers on local servers.
          </p>
        </section>
      </div>
